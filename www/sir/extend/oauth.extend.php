...
// 네이버로그인 API 정보
define('G5_NAVER_OAUTH_CLIENT_ID',  'fe9t12GLiDqjoTiW2Zjl');
define('G5_NAVER_OAUTH_SECRET_KEY', 'b1SNA0K8iu');

// 카카오로그인 API 정보
define('G5_KAKAO_OAUTH_REST_API_KEY', '0557f5e6c2940eba57bb107a309a5b13');
